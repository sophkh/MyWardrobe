					...
					<div class="row">
						...
						<div class="col-lg-8">
							<div id="content">					
								<div class="row">
									<div class="col-xs-9" >
										<h2 class="mb-none"><strong><i class="fa fa-user"></i> <?php echo $name; ?></strong></h2>
										<h4 class="heading-primary"><?php echo $email; ?></h4>
									</div>
								...
								<div class="row">
									...
									<?php while($row=mysql_fetch_array($result)){?>
										<li><i class="fa fa-circle"></i>Name : <?php echo $row["username"];?></li>
										<li><i class="fa fa-envelope"></i>Email : <?php echo $row["email"];?></li>
										<li><i class="fa fa-map-marker"></i>Address : <?php echo $row["address"];?></li>
										<li><i class="fa fa-phone-square"></i>Phone No : <?php echo $row["contact"];?></li>						
									<?php }?>	
									</ul>
									</div>
								</div>
