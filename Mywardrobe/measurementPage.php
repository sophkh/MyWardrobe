	...
	<body>
		...
		<div class="body">
			...
			<div role="main" class="main" id="profile">
				...
				<div class="row">
                    <div class="col-lg-9" >
                        <h3 class="mb-none"><strong>Self Measurements</strong></h3>
                    </div>
					 <div class="col-lg-3" style="text-align:right;"  >
						<button type="button" class="btn btn-primary mr-xs mb-sm" onClick="getMesurement();">Edit Measurements</button>
                    </div>
                </div>
	...
	<div class="row">
						...
						<div class="col-md-6">
							<section class="call-to-action with-borders button-centered mb-xl">
								<div class="col-xl-12">
								<img src="img/suit-size.jpg" width="100%">
								</div>
							</section>
						</div>						
					</div>
