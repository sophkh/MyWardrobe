            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
					<div class="row">
						<div class="col-lg-9" >
							<h3 class="box-title"><strong>My Orders</strong></h3>
						</div>
						 <div class="col-lg-3" style="text-align:right;">
							<a href="build-suit.php" class="btn btn-primary mr-xs mb-sm"  >Place New Order</a>
						</div>
					</div> 
                </div><!-- /.box-header -->
                <div class="box-body">
            ...
            <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-sm">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
													<button type="button" class="btn btn-primary" onClick="deleteOrder(<?php echo $serial;?>);">Yes</button>
												</div>
											</div>
										</div>
			</div>
