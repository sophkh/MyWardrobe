...
$sqlUser = "select * from build_suit WHERE user_id='".$uid."' AND status='inactive'";
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title"><strong>Wish List</strong></h3>
                </div><!-- /.box-header -->
                <div class="box-body">
				  ...
				  <table id="example1" class="table table-bordered table-hover">
                    ...
                    <tbody>
                      <?php while($row=mysql_fetch_array($result)){?>
 						<tr class="odd gradeX"> 
                        <?php  $serial=$row["serial"]; ?>
                        	<td><?php echo $i; ?></td>
							<td><?php echo $row["created_date"];?></td>
							<td><?php echo $row["token_number"];?></td>
							
							<td style="text-align:center;">
							<a href="javascript:void(0)" onClick="viewwishList(<?php echo $row["serial"];?>);"><i class="fa fa-eye" aria-hidden="true"></i> </a>
										/
							<a href="javascript:void(0)" onClick="editwishList(<?php echo $row["serial"];?>);"><i class="fa fa-edit fa-fw"></i></a>
										/
							<a href="javascript:void(0)" data-toggle="modal" data-target="#deleteModal");"><i class="fa fa-trash" aria-hidden="true"></i></a>
							</td>
							<td style="text-align:center;"><button type="button" class="btn btn-primary btn-xs" onClick="checkOut(<?php echo $row["serial"];?>);">Check Out</button></td>
						</tr>
					  <?php $i++; 
					  }?> 
                    </tbody>
                      ...
                      <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="smallModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-sm">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
													<button type="button" class="btn btn-primary" onClick="deleteWishList(<?php echo $serial;?>);">Yes</button>
												</div>
											</div>
										</div>
			</div>
